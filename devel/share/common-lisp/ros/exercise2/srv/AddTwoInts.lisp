...
(cl:defmethod cl:initialize-instance :after ((m <AddTwoInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddTwoInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exercise2-srv:<AddTwoInts-request> is deprecated: use exercise2-srv:AddTwoInts-request instead.")))
...
(cl:defmethod b-val ((m <AddTwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exercise2-srv:b-val is deprecated.  Use exercise2-srv:b instead.")
  (b m))
...
(cl:defmethod cl:initialize-instance :after ((m <AddTwoInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddTwoInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exercise2-srv:<AddTwoInts-response> is deprecated: use exercise2-srv:AddTwoInts-response instead.")))
